...
# fn = "datasets\parkinglot_1_480p.avi"
fn = "datasets\CUHKSquare.mpg"
# fn = "datasets\\456.mp4"



fn_yaml = "datasets\CUHKSquare.yml"
fn_out = "output4.avi"
...
while (cap.isOpened()):
    ...
    if config['save_video']:
        if video_cur_frame % 5 == 0:  # take every 30 frames
            out.write(frame_out)
    ...
    k = cv2.waitKey(1)
    if k == ord('q') or video_cur_frame == 37000:
        break
    elif k == ord('c'):
        ...
        # cap.release()
        # if config['motion_detection']: out.release()
